#' @title Generalized logit transformation
#'
#' @description This function applies a generalized logit transformation on interval [a,b].
#
#' @param x a value between a and b
#' @param a lower endpoint of an interval
#' @param b upper endpoint of an interval
#'
#' @return
#' The return object is a value between 0 and 1.
#'
#' @export
#'
...
#' @title Generalized inverse logit transformation
#'
#' @description This function applies a generalized inverse logit transformation to interval [a,b].
#
...
#'
#' @return
#' The return object is a value between a and b
#'
#' @export
#'
